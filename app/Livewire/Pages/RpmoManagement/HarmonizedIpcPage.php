...
namespace App\Livewire\Pages\RpmoManagement;
...
#[Title('Harmonized IPC')]
class HarmonizedIpcPage extends Component
{
    use WithPagination;
    ...
    public function render(): View
    {
        ...
        return view('livewire.pages.rpmo-management.harmonized-ipc-page', [
    ...
    public function resetFilters(): void
    {
        ...
        Session::forget([
            ...
            $this->sessionKey('positionFilter'),
        ]);
    ...
    {
        $row = DB::table('harmonized_ipc_targets_indicators_itemlist as itl')
        ...
        $this->editRows = DB::table('harmonized_ipc_targets_indicators_itemlist')
    ...
    public function saveAdd(): void
    {
        ...
        if ($this->addingKraCategory === null || ! in_array($this->addingKraCategory, $this->allowedKraCategories(), true)) {
            return;
        }
        ...
        app(CreateHarmonizedIpc::class)->execute($userId, $positionId, $year, $this->addingKraCategory, [
        ...
        $this->cancelAdd();
        Flux::toast(variant: 'success', text: __('Harmonized IPC target added.'));
    }
    ...
    public function saveEdit(): void
    {
        ...
        app(UpdateHarmonizedIpc::class)->execute(
    ...
    #[On('harmonized-ipc-delete-requested')]
    ...
    public function confirmDelete(): void
    {
        ...
        if (! app(DeleteHarmonizedIpc::class)->execute($indicatorId)) {
            $this->cancelDelete();
        ...
        Flux::toast(variant: 'success', text: __('Harmonized IPC target and its sub-targets deleted.'));
    }

    #[On('harmonized-ipc-subtarget-delete-requested')]
    ...
    {
        if ($this->deletingSubTargetItemId === null) {
            return;
        }

        $itemId = $this->deletingSubTargetItemId;

        if (app(DeleteHarmonizedIpc::class)->executeItem($itemId)) {
    ...
    #[On('harmonized-ipc-target-dropped')]
    ...
    public function annualTargets(): LengthAwarePaginator
    {
        ...
        return app(HarmonizedIpcDirectory::class)->paginate(
            $positionId,
